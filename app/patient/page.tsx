      ...
      <aside className="hidden md:flex flex-col w-64 bg-white border-r border-gray-100 shadow-sm min-h-screen sticky top-0">
        ...
        <div className="px-6 py-5 border-b border-gray-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-gray-900">Arnav</p>
        ...
        <main className="flex-1 overflow-y-auto pb-24 md:pb-8 max-w-lg mx-auto w-full px-4 md:px-8 pt-6 md:max-w-none md:mx-0">
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-xl font-bold text-gray-900">Arnav</p>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center text-white font-bold text-sm shadow-sm">A</div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <button className="text-sm font-medium text-indigo-600 hover:text-indigo-700 transition">View all</button>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 mb-4">
            <div className="flex items-start justify-between mb-3">
              <div>
                <p className="text-xs font-semibold text-gray-400 mb-1">REQ-001</p>
                <p className="text-base font-bold text-gray-900">Appointment Request</p>
              </div>
              <span className="px-3 py-1 rounded-full bg-emerald-50 text-emerald-600 text-xs font-semibold border border-emerald-100">Confirmed</span>
            </div>
            <div className="flex items-center gap-4 mt-2">
              <div className="flex items-center gap-1.5 text-sm text-gray-600">
                <CalendarIcon />
                <span>Wednesday, 25 February</span>
              </div>
              <div className="flex items-center gap-1.5 text-sm text-gray-600">
                <ClockIcon />
                <span>10:00 AM</span>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 mb-6">
            <div className="flex items-start justify-between">
              <div className="flex flex-col items-center flex-1 py-2">
                ...
                <p className="font-semibold text-gray-900 text-sm text-center">Follow Up Reminder</p>
                <p className="text-xs text-gray-400 text-center mt-1">You have an upcoming appointment</p>
              </div>
              <button className="p-1 text-gray-300 hover:text-gray-500 transition">
                <DotsIcon />
              </button>
            </div>
          </div>
          ...
          <button className="w-full py-3.5 bg-gray-900 hover:bg-gray-800 active:scale-[0.99] text-white rounded-2xl text-sm font-semibold transition-all shadow-md">
            View Appointments
          </button>
        </main>
